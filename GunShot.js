...
Intended for a single-shot weapon which fires once when the key bind is pressed and doesn't fire unless the key bind was released between firing.
I suggest attaching the desired AudioSource and this script to the actual weapon itself, making sure you set the key bind to the same KeyCode designation as is found in the script which is handling the rest of your weapon shooting logic.
